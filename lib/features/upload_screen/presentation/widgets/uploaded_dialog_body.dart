...
class UploadedDialogBody extends StatefulWidget {
  const UploadedDialogBody({super.key});

  @override
  State<UploadedDialogBody> createState() => _UploadedDialogBodyState();
}

class _UploadedDialogBodyState extends State<UploadedDialogBody> {
          ...
          child: Row(
            children: [
              ...
              Text(
                ...
                style: const TextStyle(color: kSkyDarkColor, fontSize: 12),
              ),
            ],
          ),
        ),
