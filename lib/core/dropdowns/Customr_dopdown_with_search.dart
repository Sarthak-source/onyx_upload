...
class CustomDropDownWithSearch extends HookWidget {
  ...
  //we will need to import more in code!,for handling any lifecycle local widget
  final String? fldNm;
  final String hint;
        ...
        children: [
          Expanded(
            child: Text(
              selectedValue ?? '',
              overflow: TextOverflow.ellipsis,
              style: AppTextStyles.styleLight12(context, color: kTextColor),
            ),
          ),
          Container(
